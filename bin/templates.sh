...
<item>
  ...
  <pubDate>${first_published}</pubDate>
  <guid>/${url_slug_root}/</guid>
...
<rss version="2.0">
  <channel>
    ...
    <lastBuildDate>$(date -Is)</lastBuildDate>
    <image>
        <url>${shite_global_data[base_url]}/${shite_global_data[title_icon]}</url>
        <link></link>
    </image>
